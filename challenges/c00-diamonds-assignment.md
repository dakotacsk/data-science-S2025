...
when diamonds are at the same carat weight. While we most likely cannot
pinpoint an exact relationship between carat and quality with price, we
can most likely determine a range with decent accuracy regarding price
based on just carat and quality. It also seems that higher carat
diamonds are more likely to be of lower quality, however, there is not
enough data points to verify that.
