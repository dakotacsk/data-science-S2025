...
- Is there “one true value” for the material properties of Aluminum?
  - No, there is not one true value for the material properties of
    Aluminum. The values of elasticity and Poisson’s ratio vary with the
    alloy, angle, and thickness of the material.
- How many aluminum alloys are in this dataset? How do you know?
  - There is 1 aluminum alloy in this dataset. I know this because the
    `num_alloys` which shows the number of distinct alloys according to
    name.
...
- It seems that angle is not a very good predictor of elasticity, as the
  values are very similar across angles, and the variation is very
  large. However, it seems that measurements from angle 45 is the most
  consistent, as the values are very close to each other, with the
  exception of one outlier. It seems, however, that thickness is a
  better predictor of elasticity. However, it is not a linear
  relationship. While the alloy is the most elastic at 0.022, and least
  elastic at 0.081, the values in between are not consistent, seeing the
  values for 0.032 and 0.064 are very similar.
...
- Does this graph support or contradict the claim above?
  - It suggests that there is a slight dependence of elasticity on the
    thickness of the material, but that could be due to other factors,
    such as measurement of sample variations.
- Is this evidence *conclusive* one way or another?
  - No. The differences seen could stem from noise, measurement errors,
    or other factors. More controlled testing is needed to draw a firm
    conclusion.
