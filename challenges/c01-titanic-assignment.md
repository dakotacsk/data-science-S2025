...
- Are there any differences?
  ...
  - The dataset has 2201 people, which means 39 people on board is not
    accounted for here.
...
First class and second class both have a 100% survival rate. Third class
has the lowest survival rates, although third class males are more
likely to survive than males in crew. Females are more likely to survive
regardless of tier (disregarding 1st and 2nd).

- Is there anything *fishy* going on in your plot?

In the graph we observe that there is a 100% survival rate for both 1st
and 2nd class passengers, which we know is not true according to the
dataset.
